...
export function createMockStatus(options: MockOptions = {}): StatusPayload {
  ...
  const decisions = [
    ...
    },
    {
      ...
      factor_metrics: {
        volume_breakout: "surge 2.10× · 24h vol $4,120,000",
        six_hour_high_break: "price 0.9213 cleared 6h high 0.9008",
        regime_not_risk_off: "regime risk-off",
        slippage_under_cap: "0.24% · cap 2.00%",
        rsi_in_range: "RSI 63.4 · band 55–75",
        derivatives_risk_clear: "funding 0.190% · OI -12.0%",
        entry_score: "68.0/100 · need 45+ · floor 40",
      },
      true_factor_count: 4,
  ...
  return {
    ...
    x402: {
      ...
      marketDataErrors: [],
      walletAddress: "0x939460466a8789c692C88CeC9E28De83a091342D",
